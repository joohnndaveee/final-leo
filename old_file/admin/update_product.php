...
if (file_exists($file_path)) {
   ...
   if(!empty($image_02)){
      if($image_size_02 > 2000000){
         ...
         $file_path = '../uploaded_img/'.$old_image_02;
...
if (file_exists($file_path)) {
   ...
   if(!empty($image_03)){
      if($image_size_03 > 2000000){
         ...
         $file_path = '../uploaded_img/'.$old_image_03;
...
<section class="update-product">
  ...
  <form action="" method="post" enctype="multipart/form-data">
   ...
   <input type="hidden" name="pid" value="<?= $fetch_products['id']; ?>"> <!-- Add this line -->
   ...
   <div class="flex">
      <div class="inputBox">
         ...
         <input type="text" class="box" required placeholder="Enter Product Name" name="name" value="<?= $fetch_products['name']; ?>">
      </div>
      <div class="inputBox">
         ...
         <div class="inputBox">
            ...
            <textarea name="details" placeholder="Enter Product Details" class="box" required cols="30" rows="10"><?= $fetch_products['details']; ?></textarea>
         </div>
         <div class="inputBox">
            <span>Update Image 1</span>
            <input type="file" name="image_01" accept="image/*" class="box">
         </div>
         <div class="inputBox">
   ...
   <script>
      document.addEventListener("DOMContentLoaded", function () {
         updateSizeOptions();
         document.getElementById("size").value = "<?= $fetch_products['size']; ?>";
      });
   </script>
